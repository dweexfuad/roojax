...
window.util_financeLib.implement({	
	...
	getDataEXSUMCC: function(model, periode, ubis, neraca, form){
		this.params.clear();
		this.params.add(model);
		this.params.add(periode);
		this.params.add(ubis);
	...
	getDataTrendCC: function(model, thn1,thn2, ubis, neraca, form){
		this.params.clear();
		this.params.add(model);
		this.params.add(thn1);
		this.params.add(thn2);
	...
	getDataTrendBudgetCC: function(model, thn1,thn2, ubis, neraca, form){
		this.params.clear();
		this.params.add(model);
		this.params.add(thn1);
		this.params.add(thn2);
	...
	getDataTrendDetail: function(model, thn1,thn2, ubis, neraca, form){
		this.params.clear();
		this.params.add(model);
		this.params.add(thn1);
		this.params.add(thn2);
	...
	getDataEXSUMDetailCC: function(model, periode, neraca, ubis, form){
    	this.params.clear();
		this.params.add(model);
		this.params.add(periode);
		this.params.add(neraca);
    ...
    getDataJejerAggUbis: function(model, periode, group, tipeBulan, form){
		this.params.clear();
        this.params.add(model);
        this.params.add(periode);
    ...
    getDataJejerActualUbis: function(model, periode, group, tipeBulan, form){
        this.params.clear();
        this.params.add(model);
        this.params.add(periode);
        this.params.add(group);
    ...
    getDataEXSUMDetail: function(model, periode, neraca, ubis, form){
    	this.params.clear();
		this.params.add(model);
		this.params.add(periode);
		this.params.add(neraca);
