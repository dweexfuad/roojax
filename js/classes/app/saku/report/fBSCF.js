window.app_saku_report_fBSCF = function(owner, pdrk)
{
	if (owner)
	{
		window.app_saku_report_fBSCF.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_report_fBSCF";
		this.itemsValue = new arrayList();		
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick", "Report Jurnal Carry Forward", 99);
		...
		this.fJenis = new saiCB(this.pnl1,{bound:[327, 23, 170, 20],labelWidth:80, caption:"Jenis Jurnal", items:["ALL","CF DEP","CF PAJAK"]});
...
window.app_saku_report_fBSCF.extend(window.childForm);
window.app_saku_report_fBSCF.implement({
	...
	doExport: function(){
		...
		this.app.services.callServices("financial_BsplMaster","xlsJurnalByJenis",[self.app._lokasi,'','CARRY_FORWARD',filter], function(data){
			self.hideLoading();
	...
	loadReport: function(){
		...
		this.app.services.callServices("financial_BsplMaster","getJurnalByJenis",[this.app._lokasi,'','CARRY_FORWARD',filter], function(data){
