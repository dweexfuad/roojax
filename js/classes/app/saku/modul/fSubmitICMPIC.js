window.app_saku_modul_fSubmitICMPIC = function(owner, pdrk)
{
	if (owner)
	{
		window.app_saku_modul_fSubmitICMPIC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_modul_fSubmitICMPIC";
		this.itemsValue = new arrayList();		
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick", "Submit BA Rekon ICM to GA", 0);
		...
		this.bOk.on("click", () => {
			...
			let status = "PIC";//this.f4.getText();
		...
		his.eMemo = new saiMemo(this.tab.childPage[1],{bound:[20,this.tab.height-55,800,50], caption:"Catatan"});
...
window.app_saku_modul_fSubmitICMPIC.extend(window.childForm);
window.app_saku_modul_fSubmitICMPIC.implement({
