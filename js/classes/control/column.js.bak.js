	...
	doDraw: function(canvas){
		try{
			...
			if (this.owner instanceof column && this.columnIndex == 0)
				...
				var node = $("<div id='"+n+"_colHead' style='position:absolute;height:100%;top:0;left:"+left+";width:"+this.width+";background:#EEEEEE;color:#007AFF;border-right:1px solid #ff0000;border-left:1px solid #007AFF'></div>");									
		...
		try{	
            ...
            for (var i = 0; i < grid.getRowCount();i++){				
				...
				if (grid instanceof saiTreeGrid){
					...
					grid.rowNode.get(i).getCanvas().css({width : width + grid.widthColNo});
				}else 
