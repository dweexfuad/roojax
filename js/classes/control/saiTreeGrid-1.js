...
window.control_saiTreeGrid = function(owner, options){	
    if (owner){
		try{			
			...
			this.freezed = false;
			this.levelColor = ["#da251d","#C6FFE4","#E6FFCF","#FFE5D0","#FFB6B3","#FCBCFF","#B7C0FF","#84D1FF","#64FFB3","#E3FF81"];
			this.levelFontColor = ["#ffffff","#000000","#000000","#000000","#000000","#000000","#000000","#000000","#000000","#000000"];
...
window.control_saiTreeGrid.implement({
	...
	setHeight: function(data){
	    ...
	    frame = $("#"+this.getFullId() + "form");
	    if (frame) frame.css({ height : data - 40 });
