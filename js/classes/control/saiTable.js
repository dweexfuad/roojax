...
window.control_saiTable = function(owner, options){
	if (owner){
		try{
			this.height = 200;
			this.widthColNo = 25;
			...
			window.control_saiTable.prototype.parent.constructor.call(this, owner);	
			this.className = "control_saiTable";
...
window.control_saiTable.extend(window.control_control);
window.saiGrid = window.control_saiTable;
window.control_saiTable.implement({
		...
		//--------------------						
			...
			for (var i = 0; i < values.length; i ++){
				...
				nodeItem.on("keyup", {resId: this.resourceId, col: i, row:len, id:id, node : node }, function(event){
					...
					if (self.bottomColumns.get(event.data.col).buttonStyle == bsEllips){
...
//-----------------------------------			
	...
	setTop: function(data){
		window.control_saiTable.prototype.parent.setTop.call(this,data);
	},
	setLeft: function(data){
		window.control_saiTable.prototype.parent.setLeft.call(this,data);
	},
	...
	setHeight: function(data){
		window.control_saiTable.prototype.parent.setHeight.call(this, data);
	...
	setWidth: function(data){
		window.control_saiTable.prototype.parent.setWidth.call(this, data);
    ...
    addListener: function(event , listener){
        ...
        window.control_saiTable.prototype.parent.addListener.call(this, event, listener);
    }
});
