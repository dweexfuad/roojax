...
class PHPExcel_Calculation {
     ...
     * Used in the destructor of PHPExcel_Worksheet before calling getInstance because
     * we don't want to create a new instance in a destructor.
     *
     * @access    public
     * @param   PHPExcel $workbook  Injected workbook for working with a PHPExcel object,
     *                                    or NULL for a standalone calculation engine
     * @return bool
     */
    public static function hasInstance(PHPExcel $workbook = NULL)
    {
        if ($workbook !== NULL)
        {
