...
class PHPPowerPoint_Shape_Chart_Series implements PHPPowerPoint_IComparable
{
    ...
    /**
	* Show Legend Key on Data Table
    */
    private $_showLegendKey = true;
    private $_showDataLabel = true;
    /**
	 ...
	 * @return PHPPowerPoint_Shape_Chart_Series
	 */
	public function setShowLegendKey($value = true) {
	        $this->_showLegendKey = $value;
	        return $this;
	}
	
	public function getShowDataLabel(){
		return $this->_showDataLabel;
	}
	public function setShowDataLabel($value ){
	...
	public function getHashCode() {
    	return md5(
    		...
    		. ($this->_showDataLabel ? "t" : "f")
    		. ($this->_showLegendKey ? "t" : "f")
    		. __CLASS__
    	);
    }
