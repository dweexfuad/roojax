...
class PHPPowerPoint_Shape_Chart_PlotArea implements PHPPowerPoint_IComparable
{
    ...
    public function setMultiType($value = false){
    	$this->_multiType = $value;
    	return $this;
    }
    public function isMultiType(){
    	return $this->_multiType;
    }
    public function addTypes(PHPPowerPoint_Shape_Chart_Type $value){
    	$this->_types[] = $value;
    	return $this;
    }
	...
	public function getDataTable(){
		if (is_null($this->_dataTable)) {
			throw new Exception('Data Table has not been set.');
		}
	    return $this->_dataTable;
	}
	public function setDataTable(PHPPowerPoint_Shape_Chart_DataTable $value){
		$this->_dataTable = $value;
		return $this;
	}
	public function hasDataTable(){
		return !is_null($this->_dataTable);
	}
	/**
	 * Get Axis X
	 *
	...
	public function getHashCode() {
    	return md5(
    		...
    		. $this->_width
    		. $this->_height
    		. (is_null($this->_dataTable) ? 'null' : $this->_dataTable->getHashCode())
    		. ($this->_multiType ? "t" : "f")
    		. __CLASS__
    	);
    }
