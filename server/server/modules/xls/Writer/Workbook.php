...
*/
require_once 'server/modules/xls/Writer/Format.php';
require_once 'server/modules/xls/Writer/BIFFwriter.php';
require_once 'server/modules/xls/Writer/Worksheet.php';
require_once 'server/modules/xls/Writer/Parser.php';
require_once 'server/modules/codeplex/PHPExcel/Shared/OLE/PPS.php';
require_once 'server/modules/codeplex/PHPExcel/Shared/OLE/PPS/Root.php';
require_once 'server/modules/codeplex/PHPExcel/Shared/OLE/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    function _storeOLEFile()
    {
        ...
        error_log("tmp dir " . $this->_tmp_dir);
        if ($this->_tmp_dir != '') {
